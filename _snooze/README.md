...
You're in luck. Once you remix this, you'll want to take a look at what the new name is. Click the `Show Live` button up in the top bar and grab that url and then head here:
...
This Power-Up makes use of the following capabilities:
* callback
* card-badges
* card-buttons
* card-detail-badges
